...
public class MessageController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cntMsg = dao.cntReceiveMsg(id);
		...
		String pagingArea = BbsPage.pagingArea(total_page, page_no, page_block_start, page_block_end, "/tspoon/message/msg.do?" );
		params.put("paging", pagingArea);
		
		list = dao.receiveMsgList(id, params);
		dao.close();
