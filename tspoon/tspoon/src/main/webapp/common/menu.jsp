			...
			<div class="navContent">
				...
				<div class="userStatus">
				 ...
				 <div class="menuStyle_01 nochild">
					<ul>
						<li class="menu_message"><a href="/tspoon/member/login.do">쪽지<span>+99</span></a></li>
						<li class="menu_board"><a href="/tspoon/member/login.do">1:1<br>게시판</a></li>
				...
				<div class="menuStyle_02">
					<h3>T알쓸신잡</h3>
					<ul>
					  <li class="ico_edu"><a href="/tspoon/member/login.do" target="_self">교육정보</a></li>
					  <li class="ico_info"><a href="/tspoon/member/login.do" target="_self">밀크T 정보</a></li>
