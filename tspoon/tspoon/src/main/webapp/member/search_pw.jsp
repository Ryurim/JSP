...
<body>
    ...
    <div id="wrap" class="wrap">
        ...
        <div id="content">
            <!--비밀번호 찾기 전체//-->
            <form  class="pwSearchWrap" action="/tspoon/member/searchPwd.do" method="post">
               ...
               <div class="formBox">
                    <input type="tel" class="itxt" id="password" name = "tel" placeholder="휴대폰 번호" />
                    <label class="title" for="password">휴대폰 번호</label>
                </div>
                <button class="button blue big" >비밀번호 찾기</button>
            </form>
            <!--//비밀번호 찾기 전체-->
        </div>
        <!--//컨텐츠 본문-->
